          ...
          <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-burnt-orange/20 border border-burnt-orange/30 rounded-full px-5 py-2 mb-8">
                <Users size={16} className="text-bright-orange" />
                <span className="text-bright-orange font-semibold text-sm">Meet the Team Behind Figgle Media</span>
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                Marketers Who Speak{' '}
                <span className="text-bright-orange">Construction</span>
              </h1>
              ...
              <div className="grid grid-cols-3 gap-6 max-w-lg mx-auto">
                <div className="text-center">
                  <div className="flex items-center justify-center w-12 h-12 bg-burnt-orange/20 rounded-full mx-auto mb-3">
                    <Award size={22} className="text-bright-orange" />
                  </div>
                ...
                <div className="text-center">
                  <div className="flex items-center justify-center w-12 h-12 bg-burnt-orange/20 rounded-full mx-auto mb-3">
                    <MapPin size={22} className="text-bright-orange" />
                  </div>
                ...
                <div className="text-center">
                  <div className="flex items-center justify-center w-12 h-12 bg-burnt-orange/20 rounded-full mx-auto mb-3">
                    <Users size={22} className="text-bright-orange" />
                  </div>
