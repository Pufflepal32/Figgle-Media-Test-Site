        ...
        <section className="relative py-24 md:py-32 bg-gradient-to-br from-navy-blue via-dark-navy to-navy overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-5">
            <svg width="100%" height="100%">
              <defs>
                <pattern id="about-lines" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
          ...
          {/* Gradient Orbs */}
          <div className="absolute top-0 left-0 w-96 h-96 bg-burnt-orange/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-10 right-10 w-72 h-72 bg-burnt-orange/5 rounded-full blur-3xl"></div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid grid-cols-3 gap-6 max-w-lg mx-auto">
                ...
                <div className="text-center">
                  ...
                  <p className="text-2xl font-bold text-white">NC & WV</p>
                  <p className="text-cream text-sm">Markets Served</p>
                </div>
                <div className="text-center">
                  <div className="flex items-center justify-center w-12 h-12 bg-burnt-orange/20 rounded-full mx-auto mb-3">
