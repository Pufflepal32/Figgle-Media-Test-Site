...
function PricingPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Contractor Web Design Pricing | Figgle Media</title>
        <meta
          name="description"
          content="Transparent pricing for contractor websites, SEO, and Google Ads management. Plans starting at $2,999. Built for construction businesses across North Carolina."
        />
