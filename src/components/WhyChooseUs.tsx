      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {reasons.map((reason, index) => (
            <div
              key={index}
              className="text-center p-8 bg-alabaster rounded-xl hover:shadow-lg transition-shadow"
            >
              <div className="inline-flex items-center justify-center w-16 h-16 bg-burnt-orange rounded-full mb-6">
                <reason.icon size={32} className="text-white" />
              </div>
              <h3 className="text-2xl font-bold text-dark-green mb-4">
                {reason.title}
              </h3>
              <p className="text-jet-black leading-relaxed">
                {reason.description}
              </p>
            </div>
          ))}
        ...
        <div className="bg-gradient-to-r from-dark-green to-burnt-orange rounded-xl p-8 text-center">
          <div className="flex items-center justify-center mb-4">
            <Shield size={48} className="text-peach" />
          </div>
          <h3 className="text-3xl font-bold text-white mb-4">
            Our Performance Guarantee
          </h3>
          <p className="text-xl text-alabaster max-w-3xl mx-auto">
